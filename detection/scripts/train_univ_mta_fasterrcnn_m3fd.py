...
def build_detector(backbone: torch.nn.Module, image_size: int = 224):
...
def main() -> None:
    ...
    parser.add_argument("--split", default="smoke_train")
    parser.add_argument("--val-split", default="smoke_val")
